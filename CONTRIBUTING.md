Contributing to CORONAatHOME Core
============================

The CORONAatHOME Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CORONAatHOME Core project, and is not to be
confused with overall CORONAatHOME Network Protocol consensus changes.

Whether a pull request is merged into CORONAatHOME Core rests with the project merge
...
Patches that change CORONAatHOME consensus rules are considerably more involved than
...
Where a patch set proposes to change the CORONAatHOME consensus, it must have been
...
The project leader is the release manager for each CORONAatHOME Core release.
