...
/** Utility functions used by the CORONAatHOME Qt UI.
 */
namespace GUIUtil
{
...
// Render CORONAatHOME addresses in monospace font
...
// Parse "coronaathome:" URI into recipient object, return true on successful parsing
