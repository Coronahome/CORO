                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received CORO from zCORO"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCORO"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCORO));
