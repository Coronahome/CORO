...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CORONAatHOME Core"),
     ...
     * override -datadir in the coronaathome.conf file in the default data directory
     * (to be consistent with coronaathomed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
