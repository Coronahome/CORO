...
spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CORONAatHOME Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CORONAatHOME address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CORONAatHOME: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCORO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CORONAatHOME Core"), this);
    aboutAction->setStatusTip(tr("Show information about CORONAatHOME Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CORONAatHOME"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CORONAatHOME addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CORONAatHOME addresses"));
    ...
    openAction->setStatusTip(tr("Open a CORONAatHOME: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CORONAatHOME Core help message to get a list with possible CORONAatHOME command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CORONAatHOME Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CORONAatHOME network", "", count));
}
...
{
    QString strTitle = tr("CORONAatHOME Core"); // default title
