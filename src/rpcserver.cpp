...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CORONAatHOME server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CORONAatHOME server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CORONAatHOME features */
        {"coronaathome", "masternode", &masternode, true, true, false},
        {"coronaathome", "listmasternodes", &listmasternodes, true, true, false},
        {"coronaathome", "getmasternodecount", &getmasternodecount, true, true, false},
        {"coronaathome", "masternodeconnect", &masternodeconnect, true, true, false},
        {"coronaathome", "masternodecurrent", &masternodecurrent, true, true, false},
        {"coronaathome", "masternodedebug", &masternodedebug, true, true, false},
        {"coronaathome", "startmasternode", &startmasternode, true, true, false},
        {"coronaathome", "createmasternodekey", &createmasternodekey, true, true, false},
        {"coronaathome", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"coronaathome", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"coronaathome", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"coronaathome", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"coronaathome", "getmasternodescores", &getmasternodescores, true, true, false},
        {"coronaathome", "mnbudget", &mnbudget, true, true, false},
        {"coronaathome", "preparebudget", &preparebudget, true, true, false},
        {"coronaathome", "submitbudget", &submitbudget, true, true, false},
        {"coronaathome", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"coronaathome", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"coronaathome", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"coronaathome", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"coronaathome", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"coronaathome", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"coronaathome", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coronaathome", "checkbudgets", &checkbudgets, true, true, false},
        {"coronaathome", "mnsync", &mnsync, true, true, false},
        {"coronaathome", "spork", &spork, true, true, false},
        {"coronaathome", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"coronaathome", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use coronaathomed, or the -server option to coronaathome-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> coronaathome-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19018/\n";
}
