...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CORONAatHOME Core coronaathome-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  coronaathome-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coronaathome transaction") + "\n" +
                               "  coronaathome-tx [options] -create [commands]   " + _("Create hex-encoded coronaathome transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coronaathome transaction
