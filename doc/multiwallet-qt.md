...
In order to support loading of multiple wallets in coronaathome-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is coronaathome.cpp.
...
Changes to coronaathome.cpp
----------------------
coronaathome.cpp is the entry point into coronaathome-qt, and as such, will require some minor modifications to provide hooks for
